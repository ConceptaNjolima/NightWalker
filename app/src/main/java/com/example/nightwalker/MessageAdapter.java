...
public class MessageAdapter extends ArrayAdapter<MessageFormat> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Log.i(SocialActivity.TAG, "getView:");
        ...
        if(TextUtils.isEmpty(message.getMessage())){
            ...
            Log.i(SocialActivity.TAG, "getView: is empty ");
            String userConnected = message.getUsername();
            messageText.setText(userConnected);

        }else if(message.getUniqueId().equals(SocialActivity.uniqueId)){
            Log.i(SocialActivity.TAG, "getView: " + message.getUniqueId() + " " + SocialActivity.uniqueId);
            ...
            Log.i(SocialActivity.TAG, "getView: is not empty");
